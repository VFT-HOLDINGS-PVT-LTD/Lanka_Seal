                    ...
                    <div class="page-content">
                        ...
                        <div class="page-tabs">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a data-toggle="tab" href="#tab1">ADD EMPLOYEE</a></li>
                                <li><a data-toggle="tab" href="#tab2">DOWNLOADS</a></li>
                                                        ...
                                                        <div class="tab-pane active" id="horizontal-form">
                                                            <form class="form-horizontal" id="frm_employee" name="frm_employee" action="<?php echo base_url(); ?>Employee_Management/ADD_Employees/insert_Data" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                        <label for="focusedinput" class="col-sm-4 control-label">Branch <span style="color: red;">*</span></label>
                                                                        <div class="col-sm-8">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-12 mb-12">
                                                                            <div class="alert alert-info" role="alert">
                                                                                Use the options below to add or update employee details via an Excel sheet.
                                                                            </div>
                                                                        </div>
                                                                        <!-- Download Section -->
                                                                        <div class="col-md-6 mb-4">
                                                                            <form class="form-horizontal"
                                                                                ...
                                                                                action="<?php echo base_url(); ?>Employee_Management/ADD_Employees/download_emp_report"
                                                                                method="POST">
                                                                                <div class="card">
                                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="col-md-6 mb-4">
                                                                            <form class="form-horizontal"
                                                                                ...
                                                                                action="<?php echo base_url(); ?>Employee_Management/ADD_Employees/upload_employee_report"
                                                                                method="POST"
