                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>Master/Loan_Types/">LOAN TYPES</a></li>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-info">
                                                        ...
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" id="frm_loan_types"
                                                                name="frm_loan_types"
                                                                action="<?php echo base_url(); ?>Master/Loan_Types/insert_Data"
                                                                ...
                                                                <div class="form-group col-sm-12">
                                                                    <div class="col-sm-8">
                                                                        <img style="margin-left: 30%; width: 100px; height: 100px;"
                                                                            src="<?php echo base_url(); ?>assets/images/loan_types.png">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group col-sm-6">
                                                                    <label for="focusedinput"
                                                                        class="col-sm-4 control-label">Loan Type
                                                                        Name</label>
                                                                    <div class="col-sm-8">
                                                                        <input type="text" class="form-control"
                                                                            id="txt_loan_type" name="txt_loan_type"
                                                                            placeholder="Ex: Home">
                                                                    </div>
                                                        ...
                                                        <div class="panel-body panel-no-padding">
                                                            <table id="example"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="odd gradeX">
                                                                        <td width='100'><?php echo $data->Loan_ID; ?>
                                                                        </td>
                                                                        <td width='100'><?php echo $data->loan_name; ?>
                                                                        </td>
                                                                        <td width="15">
                                                                            <button class="get_data btn btn-green"
                                                                                data-toggle="modal"
                                                                                data-target="#myModal" title="EDIT"
                                                                                data-id="<?php echo $data->Loan_ID; ?>"
                                                                                href=""><i
                                                                        ...
                                                                        <td width="15">
                                                                            <button class="btn btn-danger"
                                                                                ...
                                                                                onclick="delete_id(<?php echo $data->Loan_ID; ?>)"><i
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal"
                                                    action="<?php echo base_url(); ?>Master/Loan_Types/update_Data"
                                                    method="post">
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput"
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput"
                                                            class="col-sm-4 control-label">loan_name</label>
                                                        <div class="col-sm-8">
                                                            <input value="" type="text" name="loan_name" id="L_Name"
