                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>Leave_Transaction/Short_Leave_Entry/">SHORT LEAVE ENTRY</a></li>
                        </ol>
                                                    ...
                                                    <div class="panel panel-info">
                                                        ...
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" id="frm_employee_view"
                                                                ...
                                                                action="<?php echo base_url(); ?>Leave_Transaction/Short_Leave_Entry/insert_Data"
                                                                method="POST">
