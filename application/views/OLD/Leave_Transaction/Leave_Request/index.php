                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="<?php echo base_url(); ?>Leave_Transaction/Leave_Request/">LEAVE REQUEST</a></li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            <div class="panel-heading"><h2>LEAVE REQUEST</h2></div>
                                                                ...
                                                                <form class="form-horizontal" id="frm_leave_request" name="frm_leave_request" action="<?php echo base_url(); ?>Leave_Transaction/Leave_Request/insert_data" method="POST">
                                                                    ...
                                                                    <div class="form-group col-sm-12">
                                                                        ...
                                                                        <div style="float: right"  class="col-md-3">
                                                                            ...
                                                                            <!--Leave-->
                                                                            <div  class="info-tile tile-das4 has-footer">
                                                                                <div class="tile-heading">
                                                                                    <div class="pull-left"><h6>Leave Balance</h6></div>
                                                    ...
                                                    <div style="margin: 20px;" class="panel panel-default">
                                                        <div  class="panel-body panel-no-padding" >
                                                            <table  id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    foreach ($data_leave_sum as $data) {
                                                                        ...
                                                                        if ($data->Is_pending ==1) {
                                                                         ...
                                                                         if ($data->Is_Cancel) {
                                                                          ...
                                                                          if ($data->Is_Cancel == 0 && $data->Is_pending ==0) {
                                                                            echo "<td width='15'>";
...
//                                                                        echo "</td>";
                                                                        ...
                                                                        echo "<td width='15'>";
                                                                        echo "<a class='get_data btn btn-danger' href='" . base_url() . "Leave_Transaction/Leave_Approve/reject_Ind/" . $data->LV_ID . "'>REJECT<i class=''></i> </a>";
                                                                        echo "</td>";
