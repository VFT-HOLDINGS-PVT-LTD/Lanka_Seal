                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a
                                        href="<?php echo base_url(); ?>Employee_Management/View_Employees/">VIEW EMPLOYEES</a></li>
                                                            ...
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_employee_view" name="frm_employee_view" action="" method="POST">
                                                                    ...
                                                                    <div class="form-group col-sm-3">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control" name="txt_nic" id="txt_nic" placeholder="Ex: 924581565V">
                                                                        </div>
