                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="panel ">
                                                    <div style="background: rgb(59,105,129);
                                                        ...
                                                        <img style="height: 70px; float: left" src="<?php echo base_url(); ?>assets/images/user-group.png" ><h2 style="color: #ffffff">EMPLOYEE</h2>
                                                        <!--                                                        <div class="options">
                                                                                                                    <ul class="nav nav-tabs">
                                                            ...
                                                            <div class="tab-pane active" id="horizontal-form">
                                                                <form class="form-horizontal" id="frm_employee_update" name="frm_employee_update" action="<?php echo base_url(); ?>Employee_Management/Edit_Employees/update_emp" method="POST" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <select class="form-control" id="cmb_if_epf" name="cmb_if_epf">
                                                                                    <option value="<?php echo $data_set[0]->Is_EPF ?>">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <!-- add leave allocation type -->
                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput" class="col-sm-4 control-label">Leave Allocation Type</label>
                                                                            <div class="col-sm-8">
                                                                                <select class="form-control" id="cmb_leave_allocation_type" name="cmb_leave_allocation_type">
                                                                                    <option value="" default>-- Select --</option>
                                                                                    <option value="AUTO" <?php echo ($data_set[0]->leave_allocate_type == 'AUTO') ? 'selected' : ''; ?>>AUTO</option>
                                                                                    <option value="MANUAL" <?php echo ($data_set[0]->leave_allocate_type == 'MANUAL') ? 'selected' : ''; ?>>MANUAL</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="tab-pane" id="vertical-form">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control" value="<?php echo $data_set[0]->BR1 ?>" id="txt_BG_Allowance" name="txt_BG_Allowance1" required="" placeholder="Ex: 5500">
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control" value="<?php echo $data_set[0]->BR2 ?>" id="txt_BG_Allowance" name="txt_BG_Allowance2" required="" placeholder="Ex: 5500">
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                        <label for="focusedinput" class="col-sm-4 control-label">Salary Bank</label>
                                                                        <div class="col-sm-8">
                                                                            <select class="form-control" id="cmb_bank" name="cmb_bank">
                                                                                ...
                                                                                ?>
                                                                                        <option selected value="<?php echo $t_data->Bnk_ID; ?>"><?php echo $t_data->bank_name; ?></option>
                                                                                    <?php
                                                                                    } else {
                                                                                    ?>
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                        <label for="focusedinput" class="col-sm-4 control-label">Sal. Branch</label>
                                                                        <div class="col-sm-8">
                                                                            <select class="form-control" id="txt_B_Branch" name="txt_B_Branch">
                                                                                <option value="" default>-- Select --</option>
                                                                                <?php
                                                                                if (!empty($data_bnk_branch_sal[0]->ID)) {
                                                                                ?>
                                                                                    <option selected value="<?php echo $data_bnk_branch_sal[0]->ID; ?>" default><?php echo $data_bnk_branch_sal[0]->Branch_Name; ?></option>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                            </select>
...
<?php $this->load->view('template/js.php'); ?>	
                ...
                $(document).ready(function() {
                    $('#cmb_bank').change(function() {
                        ...
                        if (bankId) {
                            $.ajax({
                                url: baseurl + "Employee_Management/ADD_Employees/getBranchesByBank", // Replace with your server-side URL
                                type: 'POST',
                                data: {
                                    bank_id: bankId
                                },
                                ...
                                success: function(data) {
                                    ...
                                    branchDropdown.append('<option value="">-- Select --</option>'); // Add default option
                            ...
                            $('#cmb_branch').empty().append('<option value="">-- Select --</option>'); // Reset branch dropdown
                        }
                    });
                });
            </script>
