                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry_Request/">MANUAL ATTENDANCE REQUEST</a></li>
                                                    ...
                                                    <div class="panel panel-info">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <form class="form-horizontal" id="frm_employee_view"
                                                                ...
                                                                action="<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry_Request/emp_manual_entry"
                                                                method="POST">
