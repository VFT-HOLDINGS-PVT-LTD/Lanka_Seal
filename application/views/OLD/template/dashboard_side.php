...
<div style="border-radius: 20px; " class="static-sidebar-wrapper sidebar-default">
    <div class="static-sidebar">
        <div class="sidebar">
            <div class="" id="widget-welcomebox" style="background-color: #009ebb; color: white">
                <div class="widget-body welcome-box tabular">
                    <div class="tabular-row">
                        ...
                        <div class="tabular-cell welcome-options">
                            ...
                            <a style="color: white" href="#" class="name"><?php echo $User_Name; ?></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="acc-menu">
                        ...
                        <?php if ($currentUser[0]->master_data == 1): ?>
                            ...
                            <?php if ($currentUser[0]->master_data == 1): ?>
                                ...
                                <?php if ($currentUser[0]->weekly_roster == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Master/Weekly_Roster/">MONTHLY ROSTER PATTERN</a></li>
                                <?php endif; ?>

                                <?php if ($currentUser[0]->weekly_roster == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Master/Weekly_Roster_Excel/">ROSTER PATTERN EXCELL</a></li>
                                <?php endif; ?>
                        ...
                        <?php if ($currentUser[0]->Employee_mgt == 1): ?>
                            ...
                            <?php if ($currentUser[0]->Employee_mgt == 1): ?>  
                                ...
                                <?php if ($currentUser[0]->view_employee == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Employee_Management/View_Letter_Templates">LETTER TEMPLATES</a></li>
                                <?php endif; ?>

                                <?php if ($currentUser[0]->view_employee == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Employee_Management/View_Docs">USER DOCUMENTS</a></li>
                                <?php endif; ?>
                        ...
                        <?php if ($currentUser[0]->Attendance == 1): ?>
                            ...
                            <ul class="acc-menu">
                                ...
                                <!--<?php if ($currentUser[0]->attendance_collection == 1): ?>-->
                                <!--    <li><a href="<?php echo base_url(); ?>Attendances-Download/Attendances_Download">ATTENDANCES DOWNLOAD</a></li>-->
                                <!--<?php endif; ?>-->
                                ...
                                <?php if ($currentUser[0]->manual_att_request == 1): ?>
                                     <li><a href="<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry_Request">MANUAL ATTENDANCE REQUEST</a></li> 
                                <?php endif; ?>

                                <?php if ($currentUser[0]->Is_manual_Sup == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry_SAPP">MANUAL ATTENDANCE APPROVE</a></li>
                                <?php endif; ?>    

                                <!-- <?php if ($currentUser[0]->Is_manual_Admin == 1): ?>
                                ...
                                <!--<?php if ($currentUser[0]->attendance_process == 1): ?>-->
                                <!--    <li><a href="<?php echo base_url(); ?>Attendance/Attendance_Process_New/re_process">ATTENDANCE RE-PROCESS</a></li>-->
                                <!--<?php endif; ?>-->
                        ...
                        <?php if ($currentUser[0]->Leave_Transaction == 1): ?>
                            ...
                            <ul class="acc-menu">
                                ...
                                <?php if ($currentUser[0]->leave_allocation == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Leave_Transaction/Leave_Allocation_Edit">LEAVE ALLOCATION EDIT</a></li>
                                <?php endif; ?>

                                <!--<li><a href="ui-progress.html">INDIVIDUAL LEAVE ALLOCATION</a></li>-->
                                <?php if ($currentUser[0]->leave_app_sup == 1): ?>
                                ...
                                <?php endif; ?>
                                 ...
                                 <?php if ($currentUser[0]->leave_allocation == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Leave_Transaction/Short_Leave_Entry">SHORT LEAVE ENTRY</a></li>
                                <?php endif; ?>
                                
                                <?php if ($currentUser[0]->leave_request == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Leave_Transaction/Short_Leave_Request">SHORT LEAVE REQUEST</a></li>
                                <?php endif; ?>
                                
                                  <?php if ($currentUser[0]->leave_app_sup == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Leave_Transaction/View_Short_Leave">SHORT LEAVE APPROVE</a></li>
                                <?php endif; ?>
                        ...
                        <?php if ($currentUser[0]->Payroll == 1): ?>
                            ...
                            <?php if ($currentUser[0]->allowance == 1): ?>
                                ...
                                <?php endif; ?>
                                <!--<?php if ($currentUser[0]->salary_advance == 1): ?>-->
                                <!--    <li><a href="<?php echo base_url(); ?>Pay/Festival_Advance">FESTIVAL ADVANCE</a></li>-->
                                <!--<?php endif; ?>-->
                                <!-- <?php if ($currentUser[0]->allowance == 1): ?>
                                ...
                                <?php if ($currentUser[0]->payroll_process == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Pay/Salary_Increment">SALARY INCREMENT</a></li>
                                <?php endif; ?>
                                ...
                                <?php if ($currentUser[0]->payroll_process == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Pay/Payroll_Edit_Old">PAYROLL EDIT</a></li>
                                <?php endif; ?>
                                <?php if ($currentUser[0]->payroll_process == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Pay/Payroll_Approve">PAYROLL APPROVE</a></li>
                                <?php endif; ?>
                            </ul>
                        </li>

                        <?php if ($currentUser[0]->Cheque == 2): ?>
                        ...
                        <?php if ($currentUser[0]->Attendance_Report == 1): ?>
                            ...
                            <?php if ($currentUser[0]->Attendance_Report == 1): ?>
                                ...
                                <?php if ($currentUser[0]->in_out_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Attendance/Report_Attendance_In_Out_Tranc">TRANSACTION REPORT</a></li>
                                <?php endif; ?>

                                <?php if ($currentUser[0]->in_out_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Attendance/Report_Attendance_In_Out_Row">MISPUNCH REPORT</a></li>
                                <?php endif; ?>
                                ...
                                <!--<?php endif; ?>-->
                                <!--<?php if ($currentUser[0]->late_report == 1): ?>-->
                                <!--    <li><a href="<?php echo base_url(); ?>Reports/Attendance/Report_Attendance_ATT_Sum_Pr">PRESENT SUMMERY</a></li>-->
                                <!--<?php endif; ?> -->

                                <?php if ($currentUser[0]->late_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Attendance/Report_Attendance_ATT_Sum_Pr">PRESENT REPORT</a></li>
                                <?php endif; ?>
                                
                                <?php if ($currentUser[0]->late_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Attendance/Report_Attendance_ATT_Sum_Ab">ABSENT REPORT</a></li>
                                <?php endif; ?>
                                ...
                                <?php if ($currentUser[0]->leave_summery_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Attendance/Report_Leave_summery">LEAVE SUMMARY</a></li>
                                <?php endif; ?>

                                <?php if ($currentUser[0]->ot_summery_report == 2): ?>
                                    <li><a href="form-summernote.html">OT SUMMERY</a></li>
                                <?php endif; ?>
                                 <?php if ($currentUser[0]->request_advance == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Attendance/Report_Attendance_ATT_Sum_Emp">INTUITIVE EMPLOYEE ATTENDANCE</a></li>
                                <?php endif; ?>
                                <!--<?php if ($currentUser[0]->Attendance_Report == 1): ?>    -->
                                </ul>
                            <?php endif; ?>
                        ...
                        <?php if ($currentUser[0]->Payroll_reports == 1): ?>
                            ...
                            <?php if ($currentUser[0]->Payroll_reports == 1): ?>    
                                ...
                                <?php if ($currentUser[0]->deduction_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Payroll/Deduction_Report">DEDUCTIONS</a></li>
                                <?php endif; ?>
                                ...
                                <!--<?php if ($currentUser[0]->deduction_report == 1): ?>-->
                                <!--    <li><a href="<?php echo base_url(); ?>Reports/Payroll/Late_Deduction_Report">LATE DEDUCTION REPORT</a></li>-->
                                <!--<?php endif; ?>-->

                                <?php if ($currentUser[0]->paysheet_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Payroll/EPF_Report">MONTHLY EPF</a></li>
                                <?php endif; ?>

                                <?php if ($currentUser[0]->paysheet_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Payroll/ETF_Report">ETF REPORT</a></li>
                                <?php endif; ?>

                                <?php if ($currentUser[0]->paysheet_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Payroll/Payee_Tax_Report_PDF">PAYEE TAX REPORT PDF</a></li>
                                <?php endif; ?>
                                ...
                                <?php if ($currentUser[0]->allowance_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Payroll/R1_Form">R1 FROM</a></li>
                                <?php endif; ?>

                                <?php if ($currentUser[0]->paysheet_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Payroll/Payee_Tax_Report">PAYEE TAX REPORT</a></li>
                                <?php endif; ?>

                                <?php if ($currentUser[0]->payslip_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Payroll/Salary_Advance">SALARY ADVANCE</a></li>
                                <?php endif; ?>

                                <?php if ($currentUser[0]->payslip_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Payroll/Salary_To_Bank">SALARY TO BANK</a></li>
                                <?php endif; ?>
                        ...
                        <?php if ($currentUser[0]->Payroll_reports == 1): ?>
                            <li><a href="javascript:;"><i class="fa fa-line-chart"></i><span>CHARTS</span></a>
                            <?php endif; ?>
                            ...
                            <?php if ($currentUser[0]->Payroll_reports == 1): ?>    
                                ...
                                <?php if ($currentUser[0]->allowance_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Analysis/Salary_Analysis_chart_new">SALARY ANALYSIS CHART</a></li>
                                <?php endif; ?>

                                <?php if ($currentUser[0]->allowance_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Analysis/Attendance_Analysis_Chart">ATTENDANCE ANALYSIS CHART</a></li>
                                <?php endif; ?>
