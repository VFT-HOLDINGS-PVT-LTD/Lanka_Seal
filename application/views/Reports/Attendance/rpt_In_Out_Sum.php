            ...
            <table cellpadding="3">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black;"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black; width:130px;">NAME</th>
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black; width:50px;">LATE(M)</th>
                        <th style="font-size:11px;border-bottom: 1px solid black; width:50px;">ED(H:M)</th> 
                    </tr>
                </thead>
             <tbody>';
...
foreach ($data_set as $data) {
    ...
    $dotMint = $data->DOT;
    $dothours = floor($dotMint / 60);
    $dotmin = $dotMint - ($dothours * 60);
   
    

    $html .= ' <tr>
                        <td  style="font-size:10px;  width:60px;">' . $data->EmpNo . '</td>
                        <td  style="font-size:10px; width:130px;">' . $data->Emp_Full_Name . '</td>
                        ...
                        <td style="font-size:10px;width:50px;">' . $data->DayStatus . '</td>
                        <td style="font-size:10px;width:50px;">' . $data->LateM . '</td>
                        <td style="font-size:10px;width:50px;">' . $EDhours . ':' . $EDmin . '</td>
