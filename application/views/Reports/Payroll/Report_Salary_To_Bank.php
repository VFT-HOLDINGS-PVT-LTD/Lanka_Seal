                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>Reports/Payroll/Salary_To_Bank/">ALLOWANCE REPORT</a></li>
                                        ...
                                        <div class="col-md-12">
                                            <div class="panel panel-primary">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form class="form-horizontal" id="frm_in_out_rpt" name="frm_in_out_rpt" action="<?php echo base_url(); ?>Reports/Payroll/Salary_To_Bank/get_report" method="POST">
