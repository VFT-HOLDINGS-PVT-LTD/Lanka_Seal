                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>Reports/Payroll/C_Form/">C-Form REPORT</a></li>
                                            ...
                                            <div class="panel panel-primary">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form class="form-horizontal" id="frm_in_out_rpt"
                                                        name="frm_in_out_rpt"
                                                        action="<?php echo base_url(); ?>Reports/Payroll/C_Form/generateReport"
                                                        method="POST">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" required id="cmb_group"
                                                                        name="cmb_group">
