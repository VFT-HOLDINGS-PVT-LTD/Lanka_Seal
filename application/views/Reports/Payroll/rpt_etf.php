...
$html = '
        <div style="margin-left:200px; text-align:center; font-size:13px;">ETF REPORT</div> 
            ...
            <table cellpadding="3">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black;"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black;">EPF NO</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;">NIC NO</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;">GROSS SALARY</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;">CONTR. 3%</th>
...
foreach ($data_set as $data) {
    ...
    $total_grosssalary=intval($data->Basic_sal)+$total_grosssalary;
    $contr=intval($data->ETF_Amount)+$contr;
    $html .= '<tr>
                        <td  style="font-size:10px;">' . $data->EmpNo . '</td>
                        <td  style="font-size:10px;">' . $data->Emp_Full_Name . '</td>
                        <td  style="font-size:10px;">' . $data->EPFNO . '</td>
                        <td  style="font-size:10px;">' . $data->NIC . '</td>
                        <td style="font-size:10px;">' . number_format($data->Basic_sal, 2, '.', ',') . '</td> 
                        <td  style="font-size:10px;">' . number_format($data->ETF_Amount, 2, '.', ',') . '</td>
