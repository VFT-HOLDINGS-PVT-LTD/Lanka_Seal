                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>Reports/Payroll/EPF_Report/">EPF REPORT</a></li>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <form
                                                                action="<?php echo base_url(); ?>Reports/Payroll/EPF_Report/EPF_Report_Report_By_Cat"
                                                                ...
                                                                <div class="form-group col-sm-12">
                                                                    <div class="col-sm-6">
                                                                        <img class="imagecss"
                                                                            src="<?php echo base_url(); ?>assets/images/payroll.png">
                                                                    </div>
