                    ...
                    <div class="static-content">
                        <div class="page-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="<?php echo base_url(); ?>Pay/Salary_Advance/">SALARY ADVANCE</a></li>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            ...
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_salary_advance" name="frm_salary_advance" action="<?php echo base_url(); ?>Pay/Salary_Advance/insert_data" method="POST">
