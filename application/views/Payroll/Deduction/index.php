    ...
    <div id="wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-tabs">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a data-toggle="tab" href="#tab1">DEDUCTION</a></li>
                                <li><a data-toggle="tab" href="#tab2">VIEW DEDUCTION</a></li>
                                <li><a data-toggle="tab" href="#tab3">DEDUCTION HISTORY</a></li>
                                <li><a data-toggle="tab" href="#tab4">DOWNLOADS</a></li>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-info">
                                                        ...
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" id="frm_deduction_variable"
                                                                name="frm_deduction_variable"
                                                                action="<?php echo base_url(); ?>Pay/Deduction/insert_data"
                                                                method="POST">
                                                                ...
                                                                <div class="form-group col-sm-12">
                                                                    <div class="col-sm-8">
                                                                        <img style="margin-left: 30%; width: 100px; height: 100px;"
                                                                            src="<?php echo base_url(); ?>assets/images/deductions.png">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-sm-6">
                                                                    <label for="focusedinput"
                                                                        class="col-sm-4 control-label">Deduction
                                                                        Type</label>
                                                                    <div class="col-sm-8">
                                                                        <select class="form-control" required=""
                                                                            id="cmb_deduction" name="cmb_deduction">


                                                                            <option value="" default>-- Select --
                                                                            </option>
                                                                            <?php foreach ($data_ded as $t_data) { ?>
                                                                            <option
                                                                                value="<?php echo $t_data->Ded_ID; ?>">
                                                                                <?php echo $t_data->Deduction_name; ?>
                                                                            </option>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12 mb-12">
                                                                            <div class="alert alert-info" role="alert">
                                                                                ...
                                                                                Deduction details via an Excel
                                                                                sheet.
                                                                            </div>
                                                                        </div>
                                                                        <!-- Download Section -->
                                                                        <div class="col-md-6 mb-4">
                                                                            <form class="form-horizontal"
                                                                                ...
                                                                                action="<?php echo base_url(); ?>Pay/Deduction/download_deduction_report"
                                                                                method="POST">
                                                                                <div class="card">
                                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="col-md-6 mb-4">
                                                                            <form class="form-horizontal"
                                                                                ...
                                                                                action="<?php echo base_url(); ?>Pay/Deduction/upload_deduction_report"
                                                                                method="POST"
                                ...
                                <div class="tab-pane" id="tab3">
                                    ...
                                    <div class="row">
                                                    ...
                                                    <form class="form-horizontal" id="frm_in_out_rpt"
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" required=""
                                                                        id="cmb_fixedDeduction3"
                                                                        name="cmb_fixedDeduction3">


                                                                        <option value="" default>-- Select --</option>
                                                                        <?php foreach ($data_ded as $t_data) {?>
                                                                        <option value="<?php echo $t_data->Ded_ID; ?>">
                                                                            <?php echo $t_data->Deduction_name; ?>
                                                                        </option>
                                        ...
                                        ?>
                                                            ...
                                                            <div class="form-group col-sm-6">
                                                                <label for="focusedinput"
                                                                    class="col-sm-4 control-label">Deduction Status
                                                                    <span style="color: red;">*</span></label>
                                                                <div class="col-sm-4">
                                                                    <select class="form-control"
                                                                        id="cmb_Deductionstatus3"
                                                                        name="cmb_Deductionstatus3" required="required">


                                                                        <option value="" default>-- Select --</option>
                                                                        <option value="varialble_deduction">Varialble
                                                                            Deduction</option>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="button" id="search3" name="search3"
                                                                class="btn-green btn fa fa-check"
                                                                value="&nbsp;&nbsp;VIEW&nbsp; REPORT">
                                                            <input type="button" id="cancel3" name="cancel3"
                                                                class="btn-danger-alt btn fa fa-check"
                                                                value="&nbsp;&nbsp;CLEAR">
                                                        </div>
                                                    </form>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#frm_deduction_variable").validate();
        ...
        <script>
            ...
            $("#search").click(function () {
                ...
                $('#search_body').load("<?php echo base_url(); ?>Pay/Deduction/getDeductions", {
                    'txt_emp': $('#txt_emp').val(),
                    'txt_emp_name': $('#txt_emp_name').val(),
                    'cmb_desig': $('#cmb_desig').val(),
                    'cmb_dep': $('#cmb_dep').val(),
                    'cmb_months': $('#cmb_months').val(),
                    'cmb_years': $('#cmb_years').val(),
                    'cmb_deductions': $('#cmb_deductions').val()
                });
            });
            ...
            $("#search3").click(function () {
                ...
                $('#search_body3').load("<?php echo base_url(); ?>Pay/Deduction/getHistoryDeductions", {
                    'txt_emp3': $('#txt_emp3').val(),
                    // 'txt_emp_name3': $('#txt_emp_name3').val(),
                    // 'cmb_desig3': $('#cmb_desig3').val(),
                    // 'cmb_dep3': $('#cmb_dep3').val(),
                    'cmb_fixedDeduction3': $('#cmb_fixedDeduction3').val(),
                    'cmb_Deductionstatus3': $('#cmb_Deductionstatus3').val()
