                    ...
                    <div class="page-content">
                        ...
                        <div class="page-tabs">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a data-toggle="tab" href="#tab5">DOWNLOADS</a></li>
                                                    ...
                                                    <div class="panel panel-info">
                                                        ...
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" id="frm_variable_allowances"
                                                                ...
                                                                action="<?php echo base_url(); ?>Pay/Allowance/insert_data"
                                                                method="POST">
                                                                ...
                                                                <div class="form-group col-sm-12">
                                                                    <div class="col-sm-8">
                                                                        <img style="margin-left: 30%; width: 100px; height: 100px;"
                                                                            src="<?php echo base_url(); ?>assets/images/allowance.png">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-sm-6">
                                                                    <label for="focusedinput"
                                                                        class="col-sm-4 control-label">Allowance
                                                                        Type</label>
                                                                    <div class="col-sm-8">
                                                                        <select class="form-control" required=""
                                                                            id="cmb_allowance" name="cmb_allowance">
                                                                            ...
                                                                            <option
                                                                                value="<?php echo $t_data->Alw_ID; ?>">
                                                                                <?php echo $t_data->Allowance_name; ?>
                                                                            </option>
                                                                ...
                                                                <div class="form-group col-sm-6" id="monthDiv">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <select class="form-control" id="cmb_month"
                                                                            name="cmb_month">
                                                                            <option value="" default>--Select Month--
                                                                            </option>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                                <label for="focusedinput"
                                                                    class="col-sm-4 control-label">Month</label>
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" id="cmb_month1"
                                                                        name="cmb_month1">
                                                                        <option value="" default>--Select Month--
                                                                        </option>
                                                                        <option value="1">January</option>
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" required=""
                                                                        id="cmb_allowances" name="cmb_allowances">


                                                                        <option value="" default>-- Select --</option>
                                                                        <?php foreach ($data_alw as $t_data) {?>
                                                                        <option value="<?php echo $t_data->Alw_ID; ?>">
                                                                            <?php echo $t_data->Allowance_name; ?>
                                                                        </option>
                                                    ...
                                                    <form class="form-horizontal" id="frm_in_out_rpt"
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        name="txt_emp_name2" id="txt_emp_name2"
                                                                        placeholder="Ex: Ashan">
                                                                </div>
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                                <label for="focusedinput"
                                                                    class="col-sm-4 control-label">Designation</label>
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" id="cmb_desig2"
                                                                        name="cmb_desig2">
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                                <label for="focusedinput"
                                                                    class="col-sm-4 control-label">Department</label>
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" id="cmb_dep2"
                                                                        name="cmb_dep2">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                                <label for="focusedinput"
                                                                    class="col-sm-4 control-label">Company</label>
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" id="cmb_comp2"
                                                                        name="cmb_comp2">
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" required=""
                                                                        id="cmb_fixedallowance2"
                                                                        name="cmb_fixedallowance2">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="button" id="search2" name="search2"
                                                                class="btn-green btn fa fa-check"
                                                                value="&nbsp;&nbsp;VIEW&nbsp; REPORT">
                                                            <input type="button" id="cancel2" name="cancel2"
                                                                class="btn-danger-alt btn fa fa-check"
                                                                value="&nbsp;&nbsp;CLEAR">
                                                        </div>
                                                    </form>
                                ...
                                <div class="tab-pane" id="tab4">
                                    ...
                                    <div class="row">
                                                    ...
                                                    <form class="form-horizontal" id="frm_in_out_rpt"
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" required=""
                                                                        id="cmb_fixedallowance3"
                                                                        name="cmb_fixedallowance3">
                                        ...
                                        ?>
                                                            ...
                                                            <div class="form-group col-sm-6">
                                                                <label for="focusedinput"
                                                                    class="col-sm-4 control-label">Allowance Status
                                                                    <span style="color: red;">*</span></label>
                                                                <div class="col-sm-4">
                                                                    <select class="form-control"
                                                                        id="cmb_allowancestatus3"
                                                                        name="cmb_allowancestatus3" required="required">


                                                                        <option value="" default>-- Select --</option>
                                                                        <option value="varialble_allowance">Varialble
                                                                            Allowance</option>
                                                                        <option value="fixed_allowance">Fixed Allowance
                                                                        </option>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12 mb-12">
                                                                            <div class="alert alert-info" role="alert">
                                                                                ...
                                                                                Allowance details via an Excel
                                                                                sheet.
                                                                            </div>
                                                                        </div>
                                                                        <!-- Download Section -->
                                                                        <div class="col-md-6 mb-4">
                                                                            <form class="form-horizontal"
                                                                                ...
                                                                                action="<?php echo base_url(); ?>Pay/Allowance/download_allowance_report"
                                                                                method="POST">
                                                                                <div class="card">
                                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="col-md-6 mb-4">
                                                                            <form class="form-horizontal"
                                                                                ...
                                                                                action="<?php echo base_url(); ?>Pay/Allowance/upload_allowance_report"
                                                                                method="POST"
