                                    ...
                                    <div class="col-lg-11 col-md-12">
                                        <div class="card-body text-center">
                                            ...
                                            <a href="../main/index.html" class="text-nowrap logo-img d-block mb-4 w-100">
                                                <img src="assets/images/company/Lalan_Group_Logo.png" class="dark-logo" alt="Logo-Dark" style="width: 200px;" />
                                            </a>
                                            <h3 class="lh-base mb-4" style="font-size: 18px;">Let's get you signed in</h3>
