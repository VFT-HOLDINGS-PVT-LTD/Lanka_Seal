                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>Master/Leave_Types/">LEAVE TYPES</a></li>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-info">
                                                        ...
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" id="frm_leave_type"
                                                                name="frm_leave_type"
                                                                action="<?php echo base_url(); ?>Master/Leave_Types/insert_Data"
                                                                method="POST">

                                                                <div class="form-group col-sm-12">
                                                                    <div class="col-sm-8">
                                                                        <img class="imagecss"
                                                                            src="<?php echo base_url(); ?>assets/images/leave_add.png">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-sm-6">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <input type="text" class="form-control"
                                                                            name="txt_L_Name" id="txt_L_Name"
                                                                            placeholder="Ex: Anual Leave">
                                                                    </div>
                                                                ...
                                                                <div class="form-group col-sm-6">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <input type="number" class="form-control"
                                                                            name="txt_L_Entitle" id="txt_L_Entitle"
                                                                            placeholder="Ex: 14">
                                                                    </div>
                                                                ...
                                                                <div class="form-group col-sm-6">
                                                                    <label for="focusedinput"
                                                                        class="col-sm-4 control-label">Leave Balance
                                                                        Forward</label>
                                                                    <div class="col-sm-8 icheck-flat">
                                                                        <label class="checkbox green icheck col-sm-5">
                                                                            <input type="checkbox" name="chk_BF"
                                                                                id="chk_BF">
                                                                        </label>
                                                                    </div>
                                                        ...
                                                        <div class="panel-body panel-no-padding">
                                                            <table id="example"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="odd gradeX">
                                                                        <td width="100"><?php echo $data->Lv_T_ID; ?>
                                                                        </td>
                                                                        <td width="100"><?php echo $data->leave_name; ?>
                                                                        </td>
                                                                        <td width="100">
                                                                            <?php echo $data->leave_entitle; ?></td>
                                                                        <td width="100"><?php echo $data->leave_BF; ?>
                                                                        </td>
                                                                        <td width="100"><?php echo $data->IsActive; ?>
                                                                        </td>
                                                                        <td width="15">
                                                                            <button class="get_data btn btn-green"
                                                                                data-toggle="modal"
                                                                                data-target="#myModal" title="EDIT"
                                                                                data-id="<?php echo $data->Lv_T_ID; ?>"
                                                                                href=""><i
                                                                        ...
                                                                        <td width="15">
                                                                            <button class="btn btn-danger"
                                                                                ...
                                                                                onclick="delete_id(<?php echo $data->Lv_T_ID; ?>)"><i
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal"
                                                    action="<?php echo base_url(); ?>Master/Leave_Types/update_Data"
                                                    method="post">
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput"
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput"
                                                            class="col-sm-4 control-label">leave_name</label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput"
                                                            class="col-sm-4 control-label">leave_entitle</label>
                                                        <div class="col-sm-8">
                                                            <input value="" type="text" name="leave_entitle" id="L_Ent"
                                                                class="form-control m-wrap span6"><br>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput"
                                                            class="col-sm-4 control-label">leave_BF</label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput"
                                                            class="col-sm-4 control-label">IsActive</label>
                                                        <div class="col-sm-8">
                                                            <label class="checkbox green col-sm-5">
                    ...
                    swal({
                        ...
                        function (isConfirm) {
                            if (isConfirm) {
                                ...
                                $.ajax({
                                    url: baseurl + "index.php/Master/Leave_Types/ajax_delete/" + id,
                                    type: "POST",
                                    dataType: "JSON",
                                ...
                                $(document).ready(function () {
                                    setTimeout(function () {
                                        window.location.replace(baseurl + "Master/Leave_Types/");
                                    }, 1000);
                                });
