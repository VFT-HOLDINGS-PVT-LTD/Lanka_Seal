...
<body class="infobar-offcanvas">
    ...
    <div id="wrapper">
                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a
                                    href="<?php echo base_url(); ?>Leave_Transaction/Short_Leave_Request/">SHORT LEAVE REQUEST</a></li>
                        </ol>

                        <div class="page-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#tab1">SHORT LEAVE REQUEST</a></li>
                                <li><a data-toggle="tab" href="#tab2">VIEW SHORT LEAVE REQUEST</a></li>
                            </ul>
                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="panel panel-primary">
                                                        <div class="panel-heading">
                                                            <h2>VIEW SHORT LEAVE REQUEST</h2>
                                                        </div>
        ...
        document.getElementById('out_time').addEventListener('change', function () {
            ...
            if (inTime && outTime) {
                // Convert the time to Date objects
                ...
                // Check if the difference is more than 2 hours or negative (in_time > out_time)
                if (hoursDiff > 2 || hoursDiff < 0) {
                    alert("The 'To' time must be within 2 hours or less from the 'From' time.");
                    document.getElementById('out_time').value = ''; // Clear the "To" time input
                }
            }
        });
    </script>
