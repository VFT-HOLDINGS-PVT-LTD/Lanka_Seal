...
$data['data_bnk_branch_sal'] = $this->Db_model->getfilteredData("SELECT tbl_bank_branches.ID,tbl_bank_branches.Branch_Name FROM tbl_bank_branches 
        INNER JOIN tbl_empmaster ON tbl_bank_branches.ID = tbl_empmaster.Bnk_Br_ID WHERE tbl_empmaster.EmpNo = '$id'");
        ...
        $data['data_set'] = $this->Db_model->getfilteredData("SELECT 
                                                                    ...
                                                                    tbl_empmaster.leave_allocate_type
                                                                FROM
                                                                    tbl_empmaster
                                                                        LEFT JOIN
    ...
    public function ChangePass($EMPID) {


        $data['title'] = "Departmrnt | HRM System";
        $data['data_set'] = $EMPID;
        $this->load->view('Tools/Password_change_Emp/index', $data);
    }
    
    public function Change() {

        $User = $this->input->post('txt_emp');
