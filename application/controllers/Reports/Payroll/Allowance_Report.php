...
class Allowance_Report extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('Reports/Payroll/Report_allowances', $data);
    }
    ...
    public function Report_Allowances_by_cat() {
        ...
        $filters = [];
        if($allowance_type=="fixed_allowance"){
            ...
            if ($user_branch_id != '000') {
                if ($filter == null) {
                    $filter = "where Emp.B_id = '$user_branch_id'";
                } else {
                    $filter .= " AND Emp.B_id = '$user_branch_id'";
                }
            }
        ...
        }elseif($allowance_type=="variable_allowance"){
